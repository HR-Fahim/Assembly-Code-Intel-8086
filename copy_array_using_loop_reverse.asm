...
MAIN PROC
  ...
  mov ax, 0
  mov cx, 5 ; set loop counter to the length of the array

  lea si, array1 + 4 ; load address of the last element in array1 into si
...
copy_loop:
  ...
  inc si ; decrement source index
  dec di ; increment destination index
